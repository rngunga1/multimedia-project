 ...
 */
final class Version20220622145500 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE filme (id INT AUTO_INCREMENT NOT NULL, upload_utilizador_id INT NOT NULL, produtora VARCHAR(100) NOT NULL, titulo VARCHAR(200) NOT NULL, INDEX IDX_3A387F00A3873AAC (upload_utilizador_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
